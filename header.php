...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/png" href="assets/uploads/1.png">
		...
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container">
					<div class="menu">
						<ul>
							<li><a href="index.php"><img src="assets/uploads/home.png" alt="logo image" style="width:100px; height: 25px; "></a></li>
...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<div class="col-md-6 col-sm-12 search-area">
